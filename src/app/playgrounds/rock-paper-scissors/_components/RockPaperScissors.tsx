...
const BUTTON_STYLES: Record<Move, string> = {
  rock: "border-rose-400 text-rose-600 hover:bg-rose-50 active:bg-rose-100",
  paper: "border-blue-400 text-blue-600 hover:bg-blue-50 active:bg-blue-100",
  scissors:
    "border-green-400 text-green-600 hover:bg-green-50 active:bg-green-100",
};
...
export function RockPaperScissors() {
  ...
  return (
    <div className="flex flex-col items-center gap-6 py-6 px-4 max-w-lg mx-auto">
      <Heading level={1} className="text-center my-0">
        Rock Paper Scissors
      </Heading>
      ...
      <div className="flex gap-4 text-sm">
        <span className="px-3 py-1.5 rounded-lg bg-gray-100 border-l-2 border-green-400">
          You: <strong>{scores.user}</strong>
        </span>
        <span className="px-3 py-1.5 rounded-lg bg-gray-100 border-l-2 border-rose-400">
          AI: <strong>{scores.ai}</strong>
        </span>
        <span className="px-3 py-1.5 rounded-lg bg-gray-100 border-l-2 border-yellow-400">
      ...
      {!lastRound && (
        <div className="text-gray-400 text-lg">Make your move!</div>
      )}
            ...
            {strategyScores.map((s) => {
              ...
              return (
                <div key={s.name} className="flex items-center gap-2 text-xs">
                  <span
                    className={`w-32 truncate ${isHot ? "text-rose-500 font-bold" : "text-gray-400"}`}
                  >
                    {s.name}
                  </span>
